...
}).AddJwtBearer(option =>
{
    ...
    option.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(Enconding.UTF8.GetBytes(key))
    };
});
...
app.MapPost("/administradores/login", ([FromBody] MinimalApi.DTOs.LoginDTO loginDTO, IAdministradorServico administradorServico) =>
{
...
app.MapPost("/administradores", ([FromBody] MinimalApi.DTOs.AdministradorDTO administradorDTO, IAdministradorServico administradorServico) => {
